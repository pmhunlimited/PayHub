                    ...
                    <table class="w-full text-left">
                        <thead>
                            <tr class="bg-slate-50">
                                ...
                                <th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">Attempts</th>
                                <th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">Last Attempt</th>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php foreach ($logs as $l): ?>
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    <td class="px-6 py-4 text-xs font-mono font-bold"><?php echo $l['transaction_ref']; ?></td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 text-sm"><?php echo $l['attempt_count']; ?></td>
